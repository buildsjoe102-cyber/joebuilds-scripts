 ...
 * Diagnostics Controller (v24 - Pure Measurements Table & Cache Bust)
 */
console.log("JB Diagnostics Controller v24 initializing...");
...
const JoeBuildsDiagnostics = (() => {
  ...
  const mapToDOM = (bData, mData) => {
    ...
    // 3. Process the pure measurements table data
    const measurements = mData || [];
    ...
    measurements.forEach(m => { 
      let code = 'UNKNOWN';
      // Safely extract the element_code from the joined measurement_points row

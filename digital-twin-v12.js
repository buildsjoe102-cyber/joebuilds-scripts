 ...
 * Digital Twin Controller (v12 - Live Database Map Coordinates & Shimmer)
 */
  ...
  const processZoneData = (rooms, measurements) => {
    ...
    rooms.forEach(room => {
      ...
      zones[room.id] = { 
        ...
        map_x: room.map_x, map_y: room.map_y, // <--- READS DATABASE COORDINATES

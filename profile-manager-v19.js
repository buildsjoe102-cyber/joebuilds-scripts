 ...
 * Global Profile Manager (v19 - Universal Role Enforcement on Dropdown)
 */
const JoeBuildsProfileManager = (() => {
  ...
  const fixTerminologyAndUI = () => {
    ...
    // Fix Desktop Nav labels globally
      ...
      try {
        ...
        if (member && member.data) {
          ...
          if (opLabel) {
            ...
            // Background observer to stop other older scripts from changing it back to "Client" or "Operator"

 ...
 * Global Profile Manager (v22 - Demo Banner Pos, Email Fix, Anti-Flash Trigger)
 */
    ...
    if (window.supabase) {
      ...
      try {
        ...
        if (currentMember && currentMember.data) {
          ...
          // SET THE CORRECT EMAIL IN DROPDOWN
          ...
          // CLEAR "AUTHENTICATING" FROM SIDEBAR
          ...
          // FADE IN DATA TO PREVENT FLASHING

 ...
 * Properties Registry Controller (v16 - Combobox Datalists & Property Type)
 */
const JoeBuildsProperties = (() => {
  ...
  const handleSaveProperty = async () => {
    ...
    if(!error) { 
      ...
      // Refresh the datalists silently in the background so the new type/state is immediately available globally

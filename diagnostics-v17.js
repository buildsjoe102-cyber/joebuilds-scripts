 ...
 * Diagnostics Controller (v16 - JWT Security Lockdown & Publishable Key)
 */
console.log("JB Diagnostics Controller v16 initializing...");
...
const JoeBuildsDiagnostics = (() => {
  ...
  const init = async () => {
    try {
      ...
      // 3. SECURE TOKEN HANDSHAKE VIA CUSTOM FIELD
      let supabaseToken = '';
      try { 

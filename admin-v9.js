 ...
 * Administrative Data Controller (v9 - Full Skeleton Loader)
 */
const JoeBuildsAdmin = (() => {
  ...
  const toggleSkeletonState = (isLoading) => {
    ...
    if (isLoading) {
      if (DOM.telemetryContainer) DOM.telemetryContainer.innerHTML = `<div class="card-surface jb-skeleton-block" style="height: 150px;"></div><div class="card-surface jb-skeleton-block" style="height: 150px;"></div>`;
      if (DOM.twinNodesContainer) DOM.twinNodesContainer.innerHTML = `<div class="card-surface jb-skeleton-block" style="height: 150px;"></div><div class="card-surface jb-skeleton-block" style="height: 150px;"></div>`;
      if (DOM.pathwayContainer) DOM.pathwayContainer.innerHTML = `<div class="pathway-row jb-skeleton-block" style="height: 60px;"></div><div class="pathway-row jb-skeleton-block" style="height: 60px;"></div>`;
    }
  };

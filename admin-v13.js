 ...
 * Administrative Data Controller (v13 - Wildcard Link Reveal Fix)
 */
const JoeBuildsAdmin = (() => {
  ...
  const handleReportUpload = async (e) => {
    ...
    if(DOM.uploadStatusText) DOM.uploadStatusText.textContent = `Drag & Drop Files`; if(DOM.reportInput) DOM.reportInput.value = '';

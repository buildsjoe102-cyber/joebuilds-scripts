/**
 * Joe Builds - Admin Controller (v34 - Dynamic Access Modal Injection)
 */
console.log("JB Admin Controller v34 initializing...");
const JoeBuildsAdmin = (() => {
  ...
  const init = async () => {
    // Inject the Access Modal HTML dynamically so we don't have to keep it in Webflow
    injectAccessModal();

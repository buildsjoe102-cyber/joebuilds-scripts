/**
 * Joe Builds - Admin Controller (v30 - Upload Function Restored)
 */
console.log("JB Admin Controller v30 initializing...");
const JoeBuildsAdmin = (() => {
  ...
  const initUIEvents = () => {
    ...
    if (DOM.reportInput) { DOM.reportInput.addEventListener('change', handleReportUpload); } // Restored!

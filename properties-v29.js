/**
 * Joe Builds - Properties Registry Controller (v29 - Storage Crash Bypass)
 */
console.log("JB Properties Controller v29 initializing...");
const JoeBuildsProperties = (() => {
  ...
  const handleFileUpload = async (e) => {
    ...
    // FIX: Use a clean, non-JWT client purely to bypass the Supabase Storage UUID crash

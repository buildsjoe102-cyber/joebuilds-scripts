/**
 * Joe Builds - Admin Controller (v24 - DOM Mapping & Button Fix)
 */
console.log("JB Admin Controller v24 initializing...");
const JoeBuildsAdmin = (() => {
  ...
  const init = async () => {
    // Moved DOM mapping INSIDE the init function so everything is caught safely after load

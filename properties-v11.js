 ...
 * Properties Registry Controller (v11 - Edit Modals & Room Provisioning Restored)
 */
const JoeBuildsProperties = (() => {
  ...
  // --- MODAL FUNCTIONS (These were missing before!) ---
  ...
  const handleSaveRoom = async () => {
    ...
    if (roomId) {
      ...
      // INSERT NEW ROOM & PROVISION SENSORS
  ...
  const openPropertyDetail = async (building) => {
    ...
    // THIS REPLACES fetchBuildingAssets AND GRABS BOTH FILES AND ROOMS

 ...
 * Dashboard Controller (v22 - Precision Card Mapping)
 */
    ...
    try {
      ...
      if (targetBuildingId) {
        ...
        if (data.building) {
          ...
          // If the switcher doesn't exist yet, populate the span
          if (DOM.desktopAsset && !document.getElementById('clientPropertySwitcher')) DOM.desktopAsset.textContent = assetName;
          ...
          // EXACT DATA-TITLE MATCHING HERE

/**
 * Joe Builds - Admin Controller (v23 - File Limits & Access Tracking)
 */
    ...
    profiles.forEach(p => {
      ...
      tr.querySelectorAll('select').forEach(sel => { 
        sel.addEventListener('change', async (e) => { 
          ...
          // Update base profile for backwards compatibility
          await supabase.from('profiles').update(payload).eq('id', e.target.dataset.pid); 
          
          // Seed the advanced User Property Access table

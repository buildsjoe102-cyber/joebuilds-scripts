 ...
 * Global Profile Manager (v5 - Universal Cross-Page Compatibility)
 */
const JoeBuildsProfileManager = (() => {
  ...
  // ==========================================
  // MODULE 2: UNIVERSAL HAMBURGER MENU
  // ==========================================
  const injectHamburgerCSS = () => {
    ...
    style.innerHTML = `
      ...
      @media (max-width: 768px) {
        /* Targets BOTH old and new bottom nav class names to vaporize them */
  ...
  const setupHamburgerMenu = () => {
    ...
    // Look for BOTH versions of the HTML classes (Old vs New)
    ...
    if (headerContainer && mobileBrand) {
      ...
      // Clone the links from whichever desktop sidebar class is used
      ...
      try {
        ...
        if (member && member.data) {
          ...
          if (role === 'client' || role === 'demo') {
            ...
            // Backup observer in case React/DOM builds the header a split second later
